"""
Nós queremos aceesar a página, pegar todas os links dos livros;
acessar cada link em busca da quantidade que tem estoque, guardar tudo em listas;
...
# os livros começam no 54 e terminam no 94
